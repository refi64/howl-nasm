...
howl.util.lpeg_lexer ->
  ...
  macro = c 'preproc', P'%' * any {
    ...
    P'%' * id
    word {
      'arg', 'assign', 'define', 'defstr', 'deftok', 'depend', 'elif', 'else',
      'endif', 'endmacro', 'endrep', 'error', 'fatal', 'ifctx', 'ifdef',
      'ifempty', 'ifenv', 'ifidni', 'ifidn','ifmacro', 'iftoken', 'if',
      'include', 'line', 'local', 'macro','pathsearch', 'pop', 'push',
      'stacksize', 'strcat', 'strlen', 'substr','repl', 'rep', 'rotate',
